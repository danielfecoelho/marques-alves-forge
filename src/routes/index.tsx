        ...
        <div className="overflow-hidden rounded-lg border border-border bg-card shadow-[var(--shadow-industrial)]">
          <div className="grid lg:grid-cols-2">
            <div className="bg-secondary p-6 text-secondary-foreground sm:p-10 md:p-14">
              ...
              <div className="mt-8 rounded-md border border-white/15 bg-white/5 p-5 sm:p-6">
                ...
                <div className="mt-4 flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <a href={`tel:${PHONE_RAW}`} className="btn-accent-sweep inline-block rounded-md font-display text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl md:text-5xl">{PHONE}</a>
                    <a href={`tel:${PHONE_2_RAW}`} className="btn-accent-sweep mt-1 inline-block rounded-md font-display text-3xl font-extrabold leading-tight tracking-tight sm:text-4xl md:text-5xl">{PHONE_2}</a>
                  </div>
                </div>
              </div>
