...
import logoAsset from "@/assets/logo-centrado.jpeg.asset.json";
...
import co21 from "@/assets/cobertura-21.jpeg.asset.json";
import co22 from "@/assets/cobertura-22.jpeg.asset.json";
import co23 from "@/assets/cobertura-23.jpeg.asset.json";
import co24 from "@/assets/cobertura-24.jpeg.asset.json";
import co25 from "@/assets/cobertura-25.jpeg.asset.json";
import co26 from "@/assets/cobertura-26.jpeg.asset.json";
import co27 from "@/assets/cobertura-27.jpeg.asset.json";
...
const galleryCategories = [
  ...
  },
  {
    ...
    images: [
      ...
      co21.url, co22.url, co23.url, co24.url, co25.url,
      co26.url, co27.url,
    ],
  },
] as const;
  ...
  return (
    <section id="porque" className="relative isolate overflow-hidden bg-secondary py-16 text-secondary-foreground sm:py-24">
      <div className="absolute inset-0 z-0">
        <img src={sobreBg.url} alt="" className="h-[108%] w-full object-cover object-top sm:h-[118%]" />
        ...
        <div className="grid gap-10 sm:gap-16 lg:grid-cols-[1fr_1.4fr] lg:items-center">
          <div className="flex flex-col justify-center text-center lg:text-left">
            ...
            <p className="mt-5 text-secondary-foreground/75 text-justify">
              A Serralharia Marques Alves é reconhecida pela eficácia e qualidade nos seus serviços: remoção de amianto, revestimentos de coberturas em painel sandwich<span className="sm:-mx-1"> / </span>coberturas deck, revestimentos de fachada e estruturas metálicas.
            </p>
