...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Remoção de amianto, coberturas em painel sandwich, revestimentos de fachada e estruturas metálicas. Pedome, 4765-148. Orçamentos grátis: 916 328 909." },
      { name: "author", content: "Serralharia Marques Alves" },
      { property: "og:title", content: "Serralharia Marques Alves Lda — Pedome" },
      { property: "og:description", content: "Especialistas em remoção de amianto, painel sandwich, fachadas e estruturas metálicas." },
